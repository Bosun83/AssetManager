...
import 'package:newworld/page/assetInputtest.dart';
...
AppBar appBarPage(context) {
  return AppBar(
      ...
      actions: [
        ...
        IconButton(icon: Icon(Icons.refresh_rounded), onPressed: updateAssetStatus, ),
      ]);
}
...
void updateAssetStatus() {
  ...
  FirebaseFirestore.instance.collection('AssetList');
  ...
  FirebaseFirestore.instance.runTransaction((transaction) async {
    ...
    transaction.update(doc, {
     'evaluatedValue' : currentValue + 999
   });
  });
}